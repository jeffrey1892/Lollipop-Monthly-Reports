...
export function getReport(customerId?: string, month?: string, range: 'month' | 'quarter' = 'month'): ReportMetrics {
  ...
  // Headline engagement movement compares against the prior month
  ...
  const employeeEmailBody = 'Hi everyone,\n\nThis is a friendly reminder to complete your Lollipop check-ins. We launched Lollipop to create more open communication in our workplace — and it’s been working really well thanks to those of you who’ve been responding.\n\nYour check-in takes about 10 seconds, and every response helps us understand what’s working and where we can do better. While check-ins are optional, every voice makes the picture clearer. Thank you!\n'
